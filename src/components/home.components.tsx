    ...
    function parseExcelTemplate(filePath: string, callback: any) {
        ...
        fileWorkbook.xlsx.readFile(filePath).then(() => {
            templateWorkbook.xlsx.readFile(templatePath).then(() => {
                ...
                const dir = templatePath.substring(
                    0,
                ...
                while (
                    ...
                    [
                        ...
                        templateData.getCell(
                            `${colTemplate}${rowIndexTemplate}`
                        ).value = fileData.getCell(
                            `${col}${rowIndexFile}`
                        ).value;
                    });
        ...
        <div className="p-2">
            ...
            {path === "error" && (
                ...
                >
                    ...
                    <span className="font-medium">Error!</span> Error in parsing
            ...
            {path !== "" && path !== "error" ? (
                ...
                >
                    <Info className="inline flex-shrink-0 mr-3 w-5 h-5" />
                    <span className="font-medium">Success!</span> File parsed
                    sucessfully.
                    <button
                        type="button"
